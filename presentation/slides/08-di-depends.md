...
[click] Then, the application's code would consume it like this — annotate function parameters with it, like telling `current_user` to get its `env` string from `settings`.
