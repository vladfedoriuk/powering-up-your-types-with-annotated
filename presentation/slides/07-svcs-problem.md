...
The service locator library `svcs` recommended using Annotated types as registry keys. It worked fine at runtime, but type checkers started raising errors because the registration function expected a type object.
